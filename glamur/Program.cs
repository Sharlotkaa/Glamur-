...
namespace LibraryManagementSystem
{
    ...
    public class EBook : Book
    {
        ...
        public void CopyFile()
        {
            ...
            // Вычисляем и выводим MD5-хеш оригинального файла и копии
        ...
        public void DeleteFile()
        {
            if (File.Exists(FilePath))
            {
                ...
                FilePath = null; // Сбрасываем путь к файлу после удаления
            }
            else
            {
    ...
    class Program
    {
        ...
        static void CopyEBookFile(Library library)
        {
            ...
            if (ebook != null)
            {
                ebook.CopyFile(); // Копируем файл без запроса пути
            }
            else
            {
